...
class Blockchain {
    ...
    getBlockByHash(hash) {
        ...
        const lexicalThis =  () =>{
            ...
            return new Promise((resolve, reject) => {
                ...
                reject(Error({message:"No block with the given hash!"}))
    ...
    getBlockByHeight(height) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if(block){
                ...
                reject(Error({message:"Sorry, no block with the matching height"}));
            }
        });
    }
    ...
    getStarsByWalletAddress (address) {
        //let self = this;
       // this.requestMessageOwnershipVerification(address).then(message => message.split(':')[0]) == address?
        const lexicalThis = () => {
        let stars = [];
       ...
       //return Promise.reject('No star with the given address');
    }
    return lexicalThis();
    }
/**
